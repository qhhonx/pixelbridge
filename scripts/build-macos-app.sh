...
xcrun swiftc -O -whole-module-optimization -parse-as-library \
  ...
  macos/Localization.swift macos/TransferWatchdog.swift macos/BridgeSupport.swift macos/ActivityLog.swift macos/Diagnostics.swift macos/BurstPhoto.swift macos/CaptureDate.swift macos/PixelCleanup.swift macos/BridgeModel.swift \
