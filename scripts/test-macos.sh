...
for test in ${PIXELBRIDGE_TEST_SUITES:-StallRecoveryTests BurstPhotoTests DiagnosticsTests TaskSkippingTests ActivityLogTests BridgeSupportTests ModelPreferenceTests LocalizationTests RecoveryTests PixelCleanupTests CleanupSchedulingTests CleanupRecoveryTests ConcurrencyTests PhotoGridTests GalleryNavigationTests}; do
  xcrun swiftc -O -D PIXELBRIDGE_TESTING -parse-as-library \
    ...
    macos/Localization.swift macos/TransferWatchdog.swift macos/BridgeSupport.swift macos/ActivityLog.swift macos/Diagnostics.swift macos/BurstPhoto.swift macos/PixelCleanup.swift macos/BridgeModel.swift macos/PhotoGrid.swift \
