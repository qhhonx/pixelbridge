...
for test in BridgeSupportTests ModelPreferenceTests LocalizationTests RecoveryTests ConcurrencyTests PhotoGridTests GalleryNavigationTests; do
  xcrun swiftc -O -D PIXELBRIDGE_TESTING -parse-as-library \
    ...
    macos/Localization.swift macos/BridgeSupport.swift macos/BridgeModel.swift macos/PhotoGrid.swift \
